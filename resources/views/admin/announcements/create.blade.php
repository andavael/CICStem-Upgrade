...
<div class="page-header">
    <h1 class="page-title">Post New Announcement</h1>
...
<div class="content-panel">
    <form action="{{ route('admin.announcements.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Enter announcement title" required>
            @error('title')
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="content" rows="8" style="width: 100%; padding: 12px; border: 2px solid #dee2e6; border-radius: 8px; font-family: 'Inter', sans-serif; font-size: 15px;" placeholder="Enter announcement content..." required>{{ old('content') }}</textarea>
            @error('content')
            <div class="error-message show">{{ $message }}</div>
            @enderror
        </div>
