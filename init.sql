-- ============================================
-- CICStem Database Initialization Script
-- Database: cicstem_db
-- ============================================
CREATE DATABASE cicstem_db;
...
CREATE TABLE tutors (
    ...
    CONSTRAINT chk_tutor_sr_code_year CHECK ((SUBSTRING(sr_code, 1, 2))::INTEGER <= 23),
...
CREATE TABLE tutor_sessions (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tutor_sessions_tutor FOREIGN KEY (tutor_id) REFERENCES tutors(id) ON DELETE CASCADE,
    CONSTRAINT chk_session_status CHECK (status IN ('Scheduled', 'Ongoing', 'Completed', 'Cancelled'))
);

CREATE INDEX idx_tutor_sessions_tutor ON tutor_sessions(tutor_id);
CREATE INDEX idx_tutor_sessions_date ON tutor_sessions(session_date);
CREATE INDEX idx_tutor_sessions_status ON tutor_sessions(status);

-- ============================================
-- 7. SESSION_ENROLLMENTS TABLE
-- ============================================
CREATE TABLE session_enrollments (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_enrollments_session FOREIGN KEY (session_id) REFERENCES tutor_sessions(id) ON DELETE CASCADE,
...
-- ============================================
-- 9. NOTIFICATIONS TABLE (for tutors)
-- ============================================
...
-- ============================================
-- 10. STUDENT_NOTIFICATIONS TABLE
-- ============================================
...
CREATE INDEX idx_announcements_archived ON announcements(archived_at);

-- ============================================
-- 12. TERMS_ACCEPTANCE TABLE
-- ============================================
...
DO $$
BEGIN
    RAISE NOTICE 'CICStem database initialized successfully!';
    RAISE NOTICE 'Tables created: 14';
    RAISE NOTICE 'Subjects inserted: 8';
END $$;